...
export default function SMCStrategyLabPage() {
  ...
  }, [paper.data?.account.leverage, savedSession?.id, savedSession?.operating_mode, savedSession?.risk_pct]);
