...
type StatusAxes = {
  runtime_status?: "RUNNING" | "STARTING" | "PAUSED" | "STOPPED" | "ERROR";
...
type WorkerState = { alive?: boolean; lifecycle_state?: string; last_heartbeat?: string | null; last_transition?: string | null; uptime_seconds?: number | null; engine_reconnect_attempt?: number | null; engine_max_reconnect_attempts?: number | null; engine_reconnect_next_at?: string | null };
...
const axisTone = (value?: string) => {
  switch (value) {
    ...
    case "ERROR": case "FAILED": case "DISCONNECTED": return "red";
